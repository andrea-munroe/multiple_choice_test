...
ansDAO.addAnswer("False", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("A", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("B", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("C", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("D", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("E", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("F", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("G", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("H", (answer) => {
    console.log(answer);
})
ansDAO.addAnswer("I", (answer) => {
    console.log(answer);
})

let questDAO = new QuestionDAO();
questDAO.addQuestion("How many fingers am I holding up?", (question) => {
